...
export default {
	...
	actions: {
		...
		async getCategory1List({ commit }) {
			const result = await API.attrList.category1Id();
			if (result.code === 200) {
		...
		async getCategory2List({ commit }, category1Id) {
			...
			const result = await API.attrList.category2Id(category1Id);
			if (result.code === 200) {
		...
		async getCategory3List({ commit }, category2Id) {
			...
			const result = await API.attrList.category3Id(category2Id);
			if (result.code === 200) {
